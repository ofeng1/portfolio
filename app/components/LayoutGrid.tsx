...
export default function LayoutGrid({ cards, progress: progressProp, sectionHeight } : LayoutGridProps) {
    ...
    return (
        ...
        >
            <div
                className="
                    sticky top-0 h-[6%] min-h-[100vh] flex w-[100%] gap-[1.5rem] mx-auto pl-[5%] pr-[5%] justify-center items-center isolate contain-paint
                "
            >
              <div className="absolute left-0 top-0 w-full h-screen z-[10] pointer-events-none" 
                style={{
            ...
            <div className="mt-4 flex flex-col gap-3">
              {card.paragraph && (
                <motion.p
                  variants={{
                    hidden: { opacity: 0, y: 10 },
                    visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 500, damping: 30, delay: 0.05 } },
                  }}
              ...
              {(card.github || card.code || card.document) && (
                <motion.div
                  variants={{
                    hidden: { opacity: 0, y: 10 },
                    visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 500, damping: 30, delay: 0.1 } },
                  }}
