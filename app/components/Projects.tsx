...
const cards = [
  ...
  },
  {
    ...
    title: 'Forecasting on Federal Unemployment Rates',
    paragraph:
      'A brief study of how time-series models trained on 2009–2019 data estimate an alternative U.S. unemployment path, quantifying the pandemic labor-market shock.',
    github: 'https://github.com/ofeng1/UnemploymentTimeSeries',
    document:
      'https://github.com/ofeng1/UnemploymentTimeSeries/blob/main/Owen-Feng-174-final-project.pdf',
  },
];
