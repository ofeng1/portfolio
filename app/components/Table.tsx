...
const rows = [
  {
    ...
    children: (
      <div className="flex flex-col items-center gap-[1rem] max-w-[500px] text-left">
        ...
        <p className="text-white font-[Inter] text-[100%] font-light">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-[0.5rem] w-full max-w-[300px] text-center">
            <p className="text-white font-[Inter] text-[140%] font-medium">
              <b>Sonnet AI</b>
            </p>
            <p className="text-white font-[Inter] text-[100%] font-light">
              {' '}
        ...
        >
          ...
          >
            <img src="/images/vannevar_img.png" alt="Vannevar Labs" className="w-[120px]" />
          </motion.div>
  ...
  },
  {
    ...
    children: (
      <div className="flex flex-col gap-[1rem] items-center justify-center width-full">
        <img src="/images/resume_img.png" alt="Resume thumbnail" className="w-[400px] h-auto" />
      </div>
    ),
  },
];
